          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($communicationTemplateSms['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $communicationTemplateSms['communication_template_sms_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $communicationTemplateSms['communication_template_sms_id']; ?>" />
                <?php } ?></td>
