        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php echo $column_total_send; ?></td>
              <td class="left"><?php echo $column_total_not_send; ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="center" style="color:#006600;font-weight:bold"><?php echo $campaign['total_send']; ?></td>
              <td class="center"  style="color:#F00;font-weight:bold"><?php echo $campaign['total_notsend']; ?></td>
